        ...
        <div className="walisantri-dashboard" data-dashboard="walisantri">
            ...
            {loading ? (
                ...
                <>
                    ...
                    {/* Stats Grid - Premium Siohioma */}
                    <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-8 mt-6">
                        <div className="bg-white p-4 md:p-6 rounded-2xl md:rounded-[2rem] border border-gray-100 shadow-xl shadow-gray-200/20 flex flex-col justify-between group hover:border-indigo-300 transition-all duration-300 relative overflow-hidden">
                            ...
                            <div>
                                <p className="text-gray-500 font-medium mb-1">Total Hafalan</p>
                        ...
                        <div className="bg-white p-6 rounded-[2rem] border border-gray-100 shadow-xl shadow-gray-200/20 flex flex-col justify-between group hover:border-emerald-300 transition-all duration-300 relative overflow-hidden">
                            ...
                            <div>
                                <p className="text-gray-500 font-medium mb-1">Hafalan Lancar</p>
                                <h3 className="text-3xl font-black text-gray-900 tracking-tight">
                                    {hafalanStats.lancar}
                                </h3>
                            </div>
                        ...
                        <div className="bg-white p-6 rounded-[2rem] border border-gray-100 shadow-xl shadow-gray-200/20 flex flex-col justify-between group hover:border-rose-300 transition-all duration-300 relative overflow-hidden">
                            ...
                            <div>
                                <p className="text-gray-500 font-medium mb-1">Tagihan Pending</p>
                                <h3 className="text-3xl font-black text-gray-900 tracking-tight">
                                    {tagihanStats.pending}
                                </h3>
                            </div>
                        </div>

                        <div className="bg-white p-6 rounded-[2rem] border border-gray-100 shadow-xl shadow-gray-200/20 flex flex-col justify-between group hover:border-blue-300 transition-all duration-300 relative overflow-hidden">
                            ...
                            <div>
                                <p className="text-gray-500 font-medium mb-1">Tagihan Lunas</p>
                                <h3 className="text-3xl font-black text-gray-900 tracking-tight">
                                    {tagihanStats.lunas}
                                </h3>
                            </div>

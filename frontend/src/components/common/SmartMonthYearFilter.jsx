...
const SmartMonthYearFilter = ({ filters, onFilterChange, variant = 'row' }) => {
    ...
    if (mode === 'hijriyah') {
        return (
            <div className="flex gap-3 w-full">
                <div className="form-group flex-1 min-w-0 mb-0">
                    <label className="form-label text-xs font-semibold text-gray-500 mb-1.5 block">Bulan (Hijriyah) *</label>
                    <select
                ...
                <div className="form-group flex-1 min-w-0 mb-0">
                    <label className="form-label text-xs font-semibold text-gray-500 mb-1.5 block">Tahun (Hijriyah) *</label>
                    <input
                        type="number"
                        className="form-control"
    ...
    return (
        <div className="flex gap-3 w-full">
            <div className="form-group flex-1 min-w-0 mb-0">
                <label className="form-label text-xs font-semibold text-gray-500 mb-1.5 block">Bulan (Masehi) *</label>
                <select
                    className="form-control"
                    value={filters.bulan}
            ...
            <div className="form-group flex-1 min-w-0 mb-0">
                <label className="form-label text-xs font-semibold text-gray-500 mb-1.5 block">Tahun (Masehi) *</label>
                <input
                    type="number"
                    className="form-control"
                    value={filters.tahun}

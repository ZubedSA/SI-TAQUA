-- =========================================================================
-- FIX_CHAT_CONTACTS_V2.sql
-- Perbaikan type mismatch: varchar(255) -> TEXT
-- =========================================================================

-- =====================================================
-- FUNCTION: Get Chat Contacts (FIXED TYPE MISMATCH)
-- =====================================================
...
-- Notify success
SELECT '✅ Fungsi get_chat_contacts v2 berhasil diperbaiki!' as status;

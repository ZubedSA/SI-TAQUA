-- ==========================================
-- FIX_RPC_INSTANCE_ID_FINAL.sql
-- ==========================================
-- Corrected Return Structure to match Frontend expectations.
-- Frontend expects: rpcData.data.user_id
...
BEGIN
    ...
    INSERT INTO auth.identities (
        ...
        gen_random_uuid(),
        v_new_user_id,
        jsonb_build_object('sub', v_new_user_id, 'email', new_email, 'instance_id', v_instance_id),
        'email',
        v_new_user_id::text,
        NULL,
        NOW(),
    ...
    -- RETURN with DATA object (Frontend needs data.user_id)
...
SELECT '✅ RPC Final Corrected.' as status;
